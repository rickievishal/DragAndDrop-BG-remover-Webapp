const NavBar = () => {
    return (
       <div className="w-full max-w-lg mx-auto py-4 fixed top-0 -translate-x-1/2 left-[50%]">
            <nav className="w-full h-[50px] flex justify-center items-center px-4 py-2 rounded-xl bg-[var(--bg-secondary-color)] border border-[var(--bg-border-color)] flex shadow">
